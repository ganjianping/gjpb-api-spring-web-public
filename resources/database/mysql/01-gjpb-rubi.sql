...
CREATE TABLE `rubi_vocabulary` (
  ...
  `noun_form` varchar(100) DEFAULT NULL COMMENT 'The noun form',
  `noun_meaning` varchar(100) DEFAULT NULL COMMENT 'Meaning of the noun form',
  `noun_example` varchar(500) DEFAULT NULL COMMENT 'Example sentence using the noun form',
  `verb_form` varchar(100) DEFAULT NULL COMMENT 'The verb form',
  ...
  `adjective_form` varchar(100) DEFAULT NULL COMMENT 'The adjective form',
  `adjective_meaning` varchar(100) DEFAULT NULL COMMENT 'Meaning of the adjective form',
  `adjective_example` varchar(500) DEFAULT NULL COMMENT 'Example sentence using the adjective form',
