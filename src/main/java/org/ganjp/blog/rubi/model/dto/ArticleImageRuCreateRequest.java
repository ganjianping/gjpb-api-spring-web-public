...
@NoArgsConstructor
@AllArgsConstructor
public class ArticleImageRuCreateRequest {
    @NotBlank(message = "Article Ru ID is required")
    @Size(max = 36, message = "Article Ru ID must not exceed 36 characters")
    private String articleRuId;

    @Size(max = 500, message = "Article Ru title must not exceed 500 characters")
